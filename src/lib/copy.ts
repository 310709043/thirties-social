...
const COPY: Record<string, { zh: string; en: string }> = {
  ...
  tierFreeSub:      { zh: '配對 10 次免費 · 夜閣體驗 1 次 · 每日 2 芯', en: '10 free matches · Loft once · 2 wicks/day' },
  tierVigil:        { zh: '守夜會員',         en: 'Vigil' },
  tierVigilPrice:   { zh: 'NT$ 390 / 月',     en: 'NT$ 390 / mo' },
  tierVigilBlurb:   { zh: '無限配對 · 無限夜閣 · 每日 5 芯 · 5 種身份', en: 'Unlimited matching · Loft unlimited · 5 wicks/day · 5 identities' },
  wicksTitle:       { zh: '一次性 · 燭芯',    en: 'One-off · Wicks' },
  wicksBlurb:       { zh: '燭芯用來看照片、掀面紗、悸動——讓關係更靠近一點。', en: 'Wicks unlock photos, veils and pulses — to come a little closer.' },
