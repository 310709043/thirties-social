...
const COPY: Record<string, { zh: string; en: string }> = {
  ...
  tierVigilBlurb:   { zh: '無限配對 · 夜閣無限進出 · 每日 5 芯 · 全部 16 種身份 · 免費開火盆 · 可提出「留下彼此」', en: 'Unlimited matching · Loft every night · 5 wicks/day · all 16 identities · free rooms · may propose "keeping each other"' },
