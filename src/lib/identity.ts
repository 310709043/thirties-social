...
export const COLOR_NAMES_ZH = ['霧灰','青墨','砂金','苔綠','焦糖','沉藍','木棕','蘆白','炭','茶','杏','玫','靛','梅','雲','槐'];
export const COLOR_NAMES_EN = ['slate','umber','fawn','moss','caramel','indigo','walnut','reed','charcoal','tea','apricot','rose','mulberry','cloud','sage','ash'];
export const ADJ_ZH = ['漂木','靜物','夜雨','舊書','空房','清晨','末班','長椅','回音','走廊','抽屜','燈下'];
export const ADJ_EN = ['driftwood','still-life','night-rain','old-book','empty-room','early-hour','last-train','long-bench','echo','corridor','drawer','lamp-light'];
