        ...
        <View style={styles.container}>
          ...
          <TouchableOpacity onPress={handleEnter} activeOpacity={0.85}
            style={[styles.enterBtn, {
              backgroundColor: wicks >= 5 ? undefined : 'rgba(245,226,196,0.08)',
              borderWidth: wicks >= 5 ? 0 : 1, borderColor: 'rgba(245,226,196,0.15)',
            }]}>
            {wicks >= 5 ? (
            ...
            <View style={{ width: 1, height: 20, backgroundColor: wicks >= 5 ? 'rgba(31,16,20,0.3)' : 'transparent', zIndex: 1 }} />
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 5, zIndex: 1 }}>
              <WickGlyph size={11} color={wicks >= 5 ? '#1f1014' : L.faint} />
              <Text style={{ fontFamily: 'NotoSerifTC-Regular', fontSize: 13, color: wicks >= 5 ? '#1f1014' : L.faint }}>
                {t('loftCost', lang)}
              </Text>
            </View>
          </TouchableOpacity>
